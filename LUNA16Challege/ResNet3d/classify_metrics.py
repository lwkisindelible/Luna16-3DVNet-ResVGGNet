...
if __name__ == '__main__':
    ...
    # classify_metric_message(predict_label_file, name="roc_auc_score")
    # classify_metric_message(predict_label_file, name="confusion_matric")
    # classify_metric_message(predict_label_file, name="main_classify")