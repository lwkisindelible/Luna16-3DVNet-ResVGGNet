...
def processOriginaltraindata():
    expandslice = 13
    trainImage = "D:\luna16\LUNA 2016\process\image\\"
    trainMask = "D:\luna16\LUNA 2016\process\mask\\"
    """
    ...
    for subsetindex in range(10):
        # if subsetindex != 4:
        #     continue
        luna_path = "D:\luna16\LUNA 2016/"
        luna_subset_path = luna_path + "subset" + str(subsetindex) + "/"
        output_path = "D:\luna16\LUNA 2016\mask/"
        ...
        for fcount in range(len(file_list)):
            ...
            try:
                f = open(luna_subset_mask_path + sub_img_file + "_segmentation.mhd", 'r')
            except:
                continue
            ...
            if fcount % 5 == 0:
                print(f"subset{subsetindex}: alreadyDone:{fcount}")
            seriesindex += 1
